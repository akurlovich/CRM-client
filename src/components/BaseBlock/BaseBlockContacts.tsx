...
const BaseBlockContactsInner: FC = () => {
  return (
        ...
        <div className="baseblockSmall__deals__item">
          ...
          <div className="baseblock__contacts">
            ...
            <div className="data last">
              <div className="text">
                <span></span>
                <span>Ивановский р-н, г.Иваново, ул.Советская, 47</span>
              </div>
              <div className="icons">
                <IoPencilOutline size={20}/>
                <IoCopyOutline size={20}/>
            ...
            <div className="data">
              <div className="text">
                <span>spk_slavgorod@mail.ru</span>
                <span>общая</span>
              </div>
              <div className="icons">
                <IoPencilOutline size={20}/>
...
export const BaseBlockContacts = React.memo(BaseBlockContactsInner);